...
import center from '@/views/center'
    import discussxinshangcaipin from '@/views/modules/discussxinshangcaipin/list'
    import caipin from '@/views/modules/caipin/list'
    import yonghu from '@/views/modules/yonghu/list'
    import xinshangcaipin from '@/views/modules/xinshangcaipin/list'
...
const routes = [{
    ...
    children: [{
      ...
      ,{
	path: '/discussxinshangcaipin',
        name: '新上菜品评论',
        component: discussxinshangcaipin
      }
      ,{
	path: '/caipin',
        name: '菜品',
