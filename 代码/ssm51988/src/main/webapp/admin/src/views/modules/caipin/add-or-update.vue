    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="菜品介绍" prop="caipinjieshao">
          <el-input v-model="ruleForm.caipinjieshao" 
              placeholder="菜品介绍" clearable  :readonly="ro.caipinjieshao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="菜品介绍" prop="caipinjieshao">
              <el-input v-model="ruleForm.caipinjieshao" 
                placeholder="菜品介绍" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="菜品详细" prop="caipinxiangxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.caipinxiangxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.caipinxiangxi" label="菜品详细" prop="caipinxiangxi">
                    <span v-html="ruleForm.caipinxiangxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.caipinxiangxi = this.ruleForm.caipinxiangxi.replace(reg,'../../../ssm51988/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
