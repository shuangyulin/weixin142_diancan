	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
				...
				<swiper-item v-for="(swiper,index) in swiperList" :key="index">
					...
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(204, 153, 204, 1)","textAlign":"left"}'>发布人：</view>
					<view class="text" :style='{"color":"rgba(0, 0, 0, 1)","textAlign":"left","fontSize":"28rpx"}'>{{detail.faburen}}</view>
				</view>
                				                								                				<view class="detail-list-item" :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"20rpx  20rpx 0px 0px","borderColor":"rgba(204, 153, 204, 1)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(204, 153, 204, 1)","textAlign":"left"}'>发布时间：</view>
